...
int main() 
{        
        ReadSeller("sellerPass1.txt");
        
        //Begin of Phase 1
        Phase_1();
        printf("\nEnd of Phase 1 for %s", seller1.szSellerName);
        //End of Phase 1
        
        // Begin of Phase 2                
        Phase_2();
        printf("\nEnd of Phase 2 for %s", seller1.szSellerName);
        //End of Phase 2
        
        // Begin of Phase 3
        Phase_3();
        printf("\nEnd of Phase 3 for %s", seller1.szSellerName);
        //End of Phase 3
        return 0;
}
...
void ReadSeller(char *pszSellerFile)
{
    ...
    while( i < 1 )
    {
        fscanf(fp,"%d %s %s %s", &seller1.iType, seller1.szSellerName, seller1.szSellerPass, seller1.szSellerAcc);                
        i++;
    }
...
void Phase_1()
{
        ...
        strcat(szLogIn, "2 ");
        strcat(szLogIn, seller1.szSellerName);
        strcat(szLogIn, " ");
        strcat(szLogIn, seller1.szSellerPass);    
        strcat(szLogIn, " ");
        strcat(szLogIn, seller1.szSellerAcc);
        
        printf("\nPhase 1: Login request. User: %s password: %s Bank account: %s", seller1.szSellerName, seller1.szSellerPass, seller1.szSellerAcc);
...
{      
        ...
        ReadItemList("itemList1.txt", buffTx);
